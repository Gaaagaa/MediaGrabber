 ...
 */
x_uint32_t vlc_mgrabber_t::video_format_cbk(x_pvoid_t * xpvt_context,
                                            x_char_t * xct_chroma,
 ...
 */
x_pvoid_t vlc_mgrabber_t::video_lock_cbk(x_pvoid_t xpvt_context,
 ...
 */
x_void_t vlc_mgrabber_t::video_unlock_cbk(x_pvoid_t xpvt_context,
 ...
 */
x_void_t vlc_mgrabber_t::video_display_cbk(x_pvoid_t xpvt_context,
                                           x_pvoid_t xpvt_picture)
{
    vlc_mgrabber_t * this_ptr = (vlc_mgrabber_t *)xpvt_context;
 ...
 */
x_int32_t vlc_mgrabber_t::audio_setup_cbk(x_pvoid_t * xpvt_context,
                                          x_char_t * xct_format,
                                          x_uint32_t * xut_rate,
 ...
 */
x_void_t vlc_mgrabber_t::audio_cleanup_cbk(x_pvoid_t xpvt_context)
{
    vlc_mgrabber_t * this_ptr = *(vlc_mgrabber_t **)xpvt_context;
 ...
 */
x_void_t vlc_mgrabber_t::audio_play_cbk(x_pvoid_t xpvt_context,
 ...
 */
x_void_t vlc_mgrabber_t::audio_pause_cbk(x_pvoid_t xpvt_context,
                                         x_int64_t xit_pts)
{
    vlc_mgrabber_t * this_ptr = (vlc_mgrabber_t *)xpvt_context;
 ...
 */
x_void_t vlc_mgrabber_t::audio_resume_cbk(x_pvoid_t xpvt_context,
                                          x_int64_t xit_pts)
{
    vlc_mgrabber_t * this_ptr = (vlc_mgrabber_t *)xpvt_context;
 ...
 * \param xpvt_context data pointer as passed to libvlc_audio_set_callbacks() [IN]
 */
x_void_t vlc_mgrabber_t::audio_flush_cbk(x_pvoid_t xpvt_context,
                                         x_int64_t xit_pts)
{
    vlc_mgrabber_t * this_ptr = (vlc_mgrabber_t *)xpvt_context;
 ...
 * \param xpvt_context data pointer as passed to libvlc_audio_set_callbacks() [IN]
 */
x_void_t vlc_mgrabber_t::audio_drain_cbk(x_pvoid_t xpvt_context)
{
    vlc_mgrabber_t * this_ptr = (vlc_mgrabber_t *)xpvt_context;
 ...
 */
x_void_t vlc_mgrabber_t::audio_set_volume_cbk(x_pvoid_t xpvt_context,
 ...
 */
x_void_t vlc_mgrabber_t::handle_event_cbk(x_handle_t xht_event,
                                          x_pvoid_t xpvt_context)
{
    vlc_mgrabber_t * this_ptr = (vlc_mgrabber_t *)xpvt_context;
    this_ptr->handle_event(xht_event);
}
 ...
 * @brief 事件回调处理接口。
 */
x_void_t vlc_mgrabber_t::handle_event(x_handle_t xht_event)
{
